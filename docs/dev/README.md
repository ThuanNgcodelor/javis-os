...
- [Chatbot hiểu ngữ cảnh và kiểm soát nghiệp vụ](2026-08-chatbot-context-intelligence-plan.md) - roadmap 6 phase cho ZeO/CFC: NLU shadow không chặn khách, bảo vệ API, idempotency, conversation store, QueryPlan/router, grounding, Web catalog, Reports duyệt intent và assist canary. Phase 0 đã triển khai local; chưa bật assist.
