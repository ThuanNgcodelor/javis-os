...
2. [Master plan CFC AI Agent: hiện tại và tương lai](MASTER_PLAN_CFC_AI_AGENT_HIEN_TAI_VA_TUONG_LAI_2026-09-09.md) — điểm vào dễ hiểu: luồng hệ thống, chức năng từng file, case CRM đã có và roadmap đầy đủ.
3. [Phase roadmap nâng cấp không làm mất hệ thống cũ](PHASE_ROADMAP_CFC_AI_AGENT_NANG_CAP_KHONG_MAT_HE_THONG_CU_2026-09-09.md) — thứ tự thực thi, dependency, file tác động, test, rollout và rollback cho từng phase.
4. [Báo cáo triển khai Phase 0](PHASE_0_BASELINE_REPORT_2026-09-09.md) — contract đã khóa, dataset/runtime manifest, hàng rào replay và kết quả test thật.
5. [Tài liệu hệ thống CFC AI](../TAI_LIEU_HE_THONG_CFC_AI.md) — mô tả hệ thống và các luồng nghiệp vụ.
6. [Tổng hợp hiện trạng và bộ test Conversation Intelligence CFC](TONG_HOP_HIEN_TRANG_VA_BO_TEST_CONVERSATION_INTELLIGENCE_CFC.md) — hiện trạng kỹ thuật, giới hạn và bộ test đang dùng.
